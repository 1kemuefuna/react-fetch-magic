...
var FetchMagikContext = createContext({});

function useFetchMagik() {
    var _this = this;
    var fetchMagikContext = useContext(FetchMagikContext);
    var _a = useState(false), loading = _a[0], setLoading = _a[1];
    var _b = useState(null), error = _b[0], setError = _b[1];
    var _c = useState(null), data = _c[0], setData = _c[1];
    var makeRequest = function (config) { return __awaiter(_this, void 0, void 0, function () {
...
export { FetchMagikProvider, useFetchMagik };
